...
patientvaccinedetail.nthinjection,patientvaccinedetail.date,patientvaccinedetail.nextdate,patientvaccinedetail.skip,patientvaccinedetail.language, patientvaccinedetail.traditionalmessage, 
 patientvaccinedetail.engmessage,patientvaccinedetail.simplifiedmessage,patientvaccinedetail.language, patients.telMobile, patients.telMobileCountryCode
FROM patientvaccinedetail
 JOIN patients ON patientvaccinedetail.patientid=patients.patientNo
 
  WHERE  smsorcall ='SMS' AND status ='open' AND nextdate !=' '"); ?>
...
<td>
 ...
 <td><input class="form-control" type="text"  name="patientid[]" style="border: none" value="<?php echo $row['patientid'] ?>"></td>
 ...
 <td><input class="form-control" type="text"  name="totalnoofinjection[]" style="border: none" value="<?php echo $row['totalnoofinjection'] ?>"></td>
 <td><input class="form-control" type="text"  name="nthinjection[]" style="border: none" value="<?php echo $row['nthinjection'] ?>"></td>
<!-- <td><input class="form-control" type="text" name="date[]" style="border: none" value="<?php echo $row['date'] ?>"></td>-->
 <td><input class="form-control" type="text"  name="nextdate[]" style="border: none" value="<?php echo $row['nextdate'] ?>"></td>
<!--<td><input class="form-control" type="text"  name="skip[]" style="border: none" value="<?php echo $row['skip'] ?>"></td>-->
 <td width="200px">
 <textarea name="msg" style="border: none" class='message'><?php if($row['language'] == '繁體')
     {
...
<!--=========================================================-->	
 ...
 <td><input class="form-control phone" type="text"  name="nthinjection[]" style="border: none" value="<?php echo $row['telMobile'] ?>"></td>
 <?php
