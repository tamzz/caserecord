...
<html>
<head>
<title>Patient Vaccine  Reminder (tmr) </title>
<style> 
...
<!-- Nav Bar -->
 ...
 <section class="text-center">
    <br><br>
        <h4 align="left">Patient Injection Reminder (Tomorrow)</h4><hr><br>
...
WHERE DATEDIFF(NOW(), nextdate) = -1 AND (language ='繁體' OR language ='ENG' OR language ='简体') AND smsorcall = 'SMS'");?>
<?php
