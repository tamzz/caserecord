...
?>
<div class="print">
<div class="container">       <div class="row marketing">
...
$result = mysql_query("SELECT * FROM messagelogs
  WHERE str_to_date(dateCreated, '%Y-%m-%d') 
...
<td width="18%"><?php echo $row['senderID'] ?></td>
<td width="18%"><?php echo $row['receiverID'] ?></td>
<td width="18%"><?php echo $row['message'] ?></td>			   
<td width="10%"><?php echo $row['dateCreated'] ?></td>
