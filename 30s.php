...
<div class="jumbotron">
<h1 align="center">Display Patient Vaccination Alert (30 days)(简体)(</h1><br><br></div>
...
//$result = mysql_query("SELECT * FROM patientvaccinedetail WHERE NOW() >= nextdate - INTERVAL 30 DAY and NOW() <= nextdate AND language = '简体'")
$result = mysql_query("SELECT * FROM patientvaccinedetail WHERE DATEDIFF(NOW(), nextdate) = -30 AND language ='简体'")
