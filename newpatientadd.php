...
<div class="jumbotron">
  <h1 class="display-4">New Injection</h1><hr>

<form action="newpatient0.php" method="post">
<!--===============================================================================================================-->
  <!--Generate random no-->
...
<p>Patient ID: *</p><input type="text" style="width: 550px"class="form-control" name="patientid" value="<?php echo $_SESSION['one'];?>"/><br/>
<p>Patient HKID / Other ID: </p><input type="text" style="width: 550px"class="form-control" name="patienthkid" value="<?php echo $_SESSION['two'];?>"/><br/>
...
<p>Patient-Vaccine ID: *</p>  <input type="text" style="width: 550px" class="form-control"name="patientvid" value="<?php echo 'PVI'.' '. $second; ?>" /><br/>
