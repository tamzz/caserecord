...
$_SESSION['patientNo333'] = $row['patientNo']; 
 ...
 $_SESSION['clientnamec3330'] = $row['patientnamec']; 
...
<!-- Button trigger modal --> 
  <a  href="#MyModal" data-toggle="modal"  data-target="#myModal"title="新案件"><i class="fa fa-plus fa-2x" aria-hidden="true"></i></a>
<!--
...
<option value="Internal matter">內部</option>
</select>
</div>
</div>

<!-- hide it set default language to chinese-->
 <div class="form-group row">
...
<input id="filter" type="text" class="" placeholder="">
</div>
<br>
...
<td width="15%"><a href="previousdetail.php?vaccineid=<?php echo "$row[vaccineid]";?>&clientid=<?php echo $_GET['clientid']; ?>"><?php echo $row['vaccinename1']; ?></a></td>			   
