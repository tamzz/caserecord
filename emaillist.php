...
<br><br>
<h5> Select a Date Range</h5><hr>
<form name="frmSearch" method="post" action="emaillist2.php">
	 <br>
	    <p class="search_input">
		<label><strong> From Date </strong></label>
		<input type="date" class="form-control" name="fromdate" style="width: 250px"  />
		<br>
		
		<label><strong> To Date </strong></label>
		<input type="date"  class="form-control" name="todate" style="width: 250px"  />
		<br><br>
		<input type="submit" class="form-control" name="go" value="Search" id="ok" style="width: 250px" >
	</p>
	</form>
