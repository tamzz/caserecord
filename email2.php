...
<html>
<head>
<title>Patient Email Reminder (14Days) </title>
<style> 
...
<!-- Nav Bar -->
 ...
 <section class="text-center">
      <br><br>
        <h4 align="left">Patient Email Injection Reminder (14 Days)</h4><hr><br>
		<?php //echo $_SESSION["getvaccine"];?>
<?php //echo $_SESSION["gethkid"];?>

		 
          <!--<a href="guzzle.php"><button name="send" type="submit" class="btn btn-primary btn-lg">Send SMS Reminder</button></a>--><br>
...
WHERE DATEDIFF(NOW(), nextdate) = -14 AND (language ='繁體' OR language ='ENG' OR language ='简体') AND smsorcall = 'Email'");?>
<?php
...
<tr>
 ...
 <td><input class="form-control" type="text" size="8"  style="border: none"name="patientid[]"  value="<?php echo $row['patientid'] ?>"></td>
 ...
 <td><input class="form-control" type="text" size="15" style="border: none"  name="vaccinename[]" 
               value="<?php 
 ...
 <td><input class="form-control" type="text" size="1" style="border: none" name="totalnoofinjection[]"  value="<?php echo $row['totalnoofinjection'] ?>"></td>
 <td><input class="form-control" type="text" size="1" style="border: none" name="nthinjection[]"  value="<?php echo $row['nthinjection'] ?>"></td>
 <td><input class="form-control" type="text" size="1" style="border: none" name="date[]"  value="<?php echo $row['date'] ?>"></td>
 <td><input class="form-control" type="text" size="1"  style="border: none"name="nextdate[]"  value="<?php echo $row['nextdate'] ?>"></td>
 <td><input class="form-control" type="text" size="1"  style="border: none"name="skip[]"  value="<?php echo $row['skip'] ?>"></td>

  <td><input class="form-control" type="text" size="20"  style="border: none"name="subject[]" 
               value="<?php 
...
<td width="200px">
 <textarea name="msg" style="border: none"><?php if($row['language'] == '繁體')
     {
     ...
     {
      $specific[] = ["email" => $row["email"],
                     "subject" => "Vaccine Injection Reminder (14Days)",
