...
<html>
<head>
<h1><title>Patient Vaccine Call Reminder (30 Days) </title></h1>
<style> 
@media print
{
...
<?php //echo $_SESSION["gethkid"];?>
  ...
  <div class="main-wrap" id="main-content">
      ...
      <br><br>
        <h4 align="left">Patient Injection Reminder (30 Days)</h4><hr><br> <br>
...
WHERE DATEDIFF(NOW(), nextdate) = -30 AND (language ='繁體' OR language ='ENG' OR language ='简体') AND smsorcall = 'Call'");?>
<?php
...
<tr>
 ...
 <!-- *********Language of the Name of the patient will be shown according to their preferred language************* -->
              ...
              <td><input class="form-control" type="text" size="15" style="border: none" name="patientname[]" 
              value="<?php 
			  if($row['language'] == '繁體') 
