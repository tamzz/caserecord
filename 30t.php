...
<html>
<head>
<title>Patient Vaccine  Reminder (30 Days) </title>
<style> 
...
<!-- Nav Bar -->
 ...
 <section class="text-center">
      <br><br>
        <h4 align="left">Patient Injection Reminder (30 Days)</h4><hr><br>
...
<th>Previous Injection Date</th> <th>Next Injection Date</th> <th>Injection Skip<br>of Days </th>
...
WHERE DATEDIFF(NOW(), nextdate) = -30 AND (language ='繁體' OR language ='ENG' OR language ='简体') AND smsorcall = 'SMS'");?>
<?php
...
<tr>
 ...
 <!--  ********** The input field will show the value with reference to the patient's preferred language******** -->
 <td><input class="form-control" type="text" size="15" name="vaccinename[]" 
               value="<?php 
 ...
 <td><input class="form-control" type="text" size="1" name="totalnooftreatment[]" style="border: none" value="<?php echo $row['totalnoofinjection'] ?>"></td>
...
//**********Include messages with different languages using a if /if else statement*******************
       if($row['language'] == '繁體')
     {
