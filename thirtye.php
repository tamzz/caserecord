...
<html>
<head>
<h1><title>Patient Vaccine Call Reminder (Tomorrow) </title></h1>
<style> 
@media print
{
...
<?php //echo $_SESSION["gethkid"];?>
       ...
       <br><br>
        <h4 align="left">Patient Injection Reminder (Tomorrow)</h4><hr><br><br>
		<p>Please call the following patients to remind them of their coming vaccine appointment </p>
		

		<input type="button" name="print" class="btn btn-outline-secondary" style="color: black" value="Print" id="print"><br>
        <br></p></div>
        </section>
...
WHERE DATEDIFF(NOW(), nextdate) = -1 AND (language ='繁體' OR language ='ENG' OR language ='简体') AND smsorcall = 'Call'");?>
<?php
...
<tr>
 ...
 <!-- *********Language of the Name of the patient will be shown according to their preferred language************* -->
              ...
              <td><input style="border: none" class="form-control" type="text" size="15" name="patientname[]" 
              value="<?php 
			  if($row['language'] == '繁體') 
 ...
 <!-- *********Language of the Name of the Vaccine will be shown according to patient preferred language************* -->
               ...
               <td><input style="border: none" class="form-control" type="text" size="15" name="vaccinename[]" 
               value="<?php 
