...
$result = mysql_query("SELECT *FROM patientvaccinedetail
WHERE patienthkid = '". $_GET['clientid']."' AND vaccineid ='". $_GET['vaccineid']."' GROUP BY vaccineid");?>
<?php
...
<tr class="th2">
<th>次數</th><th>跟進</th> <th>狀態</th> <th>期待日期</th><th>間隔</th><th>規劃</th><th>備註</th>
      </tr>
...
AND done != 'done' ")  or die(mysql_error());?>          
