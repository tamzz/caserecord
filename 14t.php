...
<html>
<head>
<title>Patient Vaccine  Reminder (14Days) </title>
<style> 
...
<!-- Nav Bar -->
 ...
 <section class="text-center">
        ...
        <br><h4 align="left">Patient Injection Reminder (14 Days)</h4><hr><br>
...
WHERE DATEDIFF(NOW(), nextdate) = -14 AND (language ='繁體' OR language ='ENG' OR language ='简体') AND smsorcall = 'SMS'");?>
<?php
