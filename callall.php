...
$result = mysql_query("SELECT *FROM patientvaccinedetail
    ...
    WHERE  (smsorcall ='Call' OR smsorcall ='EmailCall' OR smsorcall ='SMSEmailCall' OR smsorcall ='SMSCall' )  AND nextdate !=' '"); ?>
...
<tr>
 ...
 <td width="15%"><?php echo $row['nextdate'] ?></td>
...
echo '<td width="15%">' . $row['callno'] . '</td>';
//echo '<td width="15%">' . $row['countrycode'] . '</td>';
