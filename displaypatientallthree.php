  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
	   ...
	   <li class="nav-item">
        <a class="nav-link" href="displaypatientallthree.php"><p>| <i class="fa fa-users" aria-hidden="true"></i> Patient Injection Record |</p></a>
      </li> 
  <li class="nav-item">
...
<!-- Nav Bar -->
  ...
  <input type="hidden" name="pidpid" value="<?php echo $_SESSION['three'];?>">
...
$result = mysql_query("SELECT *FROM patients
WHERE patientNo = '" . $_SESSION['three'] . "'");?>
...
FROM patientvaccinedetail WHERE patientid = '" . $_SESSION['three'] . "' AND status= 'open' Group by vaccineid")	or die(mysql_error());?>            <!-- display data in an editable table-->
    ...
    exit;
			...
			<!--============================-->
		       <td> <a href="displaypatientallthree1.php?vaccineid=<?php echo "$row[vaccineid]";?>&patientid=<?php echo "$_SESSION[getvaccine]"; ?>"><?php echo $row['vaccinename3'];?></a></td>
...
<option value="ENG" <?php if($row['language'] == 'ENG') echo 'selected="selected"'; ?> >ENG</option>
              ...
              <td><select class="form-control msg" name="status[]" readonly>
