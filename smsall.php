...
<?php// echo $_SESSION["gethkid"];?>
          ...
          <a href="guzzle.php"><button name="send" onclick="return confirm('你確定要發送嗎？');" type="submit" class="btn btn-outline-secondary" style="color: black">發簡訊</button></a>
...
$result = mysql_query("SELECT *FROM patientvaccinedetail
   ...
   WHERE  (smsorcall ='SMS' OR smsorcall ='SMSEmail' OR smsorcall ='SMSEmailCall')  AND nextdate !=' '"); ?>
