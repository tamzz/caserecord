...
<?php// echo $_SESSION["gethkid"];?>
 ...
 <!--<a href="guzzle.php"><button name="send" type="submit" class="btn btn-primary btn-lg">Send SMS Reminder</button></a>-->
	...
	<a href="emailapi.php"><button name="send" onclick="return confirm('你確定要發送嗎？');" type="submit" class="btn btn-secondary" style="color: black">發電子郵件 </button></a>
    </p>
    </div>
    </section>
<!-- Nav Bar -->
...
$result = mysql_query("SELECT *
 ...
 FROM patientvaccinedetail
    ...
    WHERE str_to_date(nextdate, '%Y-%m-%d') 
	  ...
	  (smsorcall ='Email'OR smsorcall ='SMSEmail' OR smsorcall ='SMSEmailCall' OR smsorcall ='EmailCall') "); ?>
